...
import javaproject.MainPage;

public class Room201 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Room201 room201 = new Room201();
					room201.frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public Room201(String userId) {
		...
		// 201호 이미지 - 클릭하면 이미지 바뀌게
		JLabel rmimgLb = new JLabel();
		Toolkit kit = Toolkit.getDefaultToolkit();
		Image img1 = kit.getImage("javaproject/images/m201.jpg");
		Image img2 = kit.getImage("javaproject/images/201-1.jpg");
		Image img3 = kit.getImage("javaproject/images/201-2.jpg");
		Image img4 = kit.getImage("javaproject/images/201-3.jpg");
		...
		//객실 타이틀 라벨 
				JLabel rmtitle = new JLabel("201호 (Deluxe Family Room)");

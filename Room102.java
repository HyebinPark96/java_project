...
public class Room102 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Room102 room102 = new Room102();
					room102.frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		// 102호 이미지 - 클릭하면 이미지 바뀌게
		JLabel rmimgLb = new JLabel();
		Toolkit kit = Toolkit.getDefaultToolkit();
		Image img1 = kit.getImage("javaproject/images/m102.jpg");
		Image img2 = kit.getImage("javaproject/images/102-1.jpg");
		Image img3 = kit.getImage("javaproject/images/102-2.jpg");
		Image img4 = kit.getImage("javaproject/images/102-3.jpg");
		...
		//객실 타이틀 라벨 
				JLabel rmtitle = new JLabel("102호 (Deluxe Room)");

...
public class Room101 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Room101 room101 = new Room101();
					room101.frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public Room101(String userId) {
		...
		// 101호 이미지 - 클릭하면 이미지 바뀌게
		JLabel rmimgLb = new JLabel();
		Toolkit kit = Toolkit.getDefaultToolkit();
		Image img1 = kit.getImage("javaproject/images/m101.jpg");
		Image img2 = kit.getImage("javaproject/images/101-1.jpg");
		Image img3 = kit.getImage("javaproject/images/101-2.jpg");
		Image img4 = kit.getImage("javaproject/images/101-3.jpg");
		...
		//객실 타이틀 라벨 
				JLabel rmtitle = new JLabel("101호 (Standard Room)");
		...
		rmtext.setEditable(false);//텍스트 수정 불가능
